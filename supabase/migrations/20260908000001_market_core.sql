-- Migration 20260908_000001 — market core (domains, sales, finalize_takeover)
-- Source of truth: db/schema.sql. This file is the versioned migration
-- equivalent — apply via `supabase db push` or `psql`. Keep db/schema.sql
-- in sync so a fresh project can still be bootstrapped from the db/ SQL files
-- alone, but treat these migrations as the canonical ordered history.
