-- Migration 20260908_000002 — identity, quotes, payment observability, moderation, RLS, realtime
-- Source of truth: db/schema-extended.sql
...
do $$
begin
  -- Publication may not exist on some hosted Postgres not using Supabase Realtime.
